...
// const cycle1 = new Cycling([39, -12], 27, 60, 523);
...
class App {
  ...
  _newWorkout(e) {
    ...
    if (type === 'running') {
      ...
      if (
        ...
        return alert(`Invalid inputs!. Only positive numbers are to be filled`);
  ...
  _renderWorkout(workout) {
    ...
    <div class="workout__details">
      ...
      <span class="workout__value"${workout.duration}24</span>
...
/*
  ...
  4. sort workout by certain fields (eg distance)
  5. More realistic error and confirmation messages

  Hard
  1. Ability to position map to show all workouts
  2. Ability to draw shapes instead of points
  
  Only after Asynchronous Module
  1. Geocode Location
  2. Display weather data for the workout time and place
*/